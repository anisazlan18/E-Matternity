  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="col-lg-12">
		...
		<div class="card">
          <div class="card-body">
            <h5 class="card-title">Carian Pesakit</h5>
					...
					<form method="post" action="" class="row g-3">
                        <div class="row col-sm-6">
							...
							<div class="col-md-3">
							<label for="nric" class="form-label">&nbsp;</label>
							<button type="submit" class="form-control 	btn btn-primary">Carian</button>
							</div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <table class="table table-striped">
			  ...
			  <?PHP
				$bil = 0;
				$SQL_patient = "SELECT * FROM `patient` WHERE `nric` = '$nric' " ;
                ...
                <tr>
                  ...
                  <td><a href="h-main1.php?id_patient=<?PHP echo $data["id_patient"]; ?>" class="btn btn-primary" role="button">Lihat Rekod</a></td>
                </tr>
				<?PHP } ?>
              </tbody>
            </table>
