              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="list-group">
					...
					<a href="main7.php?id_patient=<?PHP echo $id_patient; ?>" class="list-group-item list-group-item-action active" aria-current="true">Kata Laluan</a>
                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      <form method="post" action="" class="row g-3" >
                        ...
                        <div class="col-md-6">
                          <label for="job" class="form-label">Kata Laluan</label>
