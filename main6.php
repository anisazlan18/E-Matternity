...
$uri		= (isset($_POST['uri'])) ? trim($_POST['uri']) : '0';
$sintometrin= (isset($_POST['sintometrin'])) ? trim($_POST['sintometrin']) : '0';
$ergometrin	= (isset($_POST['ergometrin'])) ? trim($_POST['ergometrin']) : '0';
...
$pph		= (isset($_POST['pph'])) ? trim($_POST['pph']) : '0';
$perineum	= (isset($_POST['perineum'])) ? trim($_POST['perineum']) : '0';
$lain4		= (isset($_POST['lain4'])) ? trim($_POST['lain4']) : '';
$lahir_hidup= (isset($_POST['lahir_hidup'])) ? trim($_POST['lahir_hidup']) : '0';
$apgar		= (isset($_POST['apgar'])) ? trim($_POST['apgar']) : '';
$abnormaliti= (isset($_POST['abnormaliti'])) ? trim($_POST['abnormaliti']) : '0';
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="list-group">
                    ...
                    <a href="main6.php?id_patient=<?PHP echo $id_patient; ?>" class="list-group-item list-group-item-action active"aria-current="true">Perihal Kelahiran Bayi</a>
                    ...
                    <div class="card-body">
                      ...
                      <form method="post" action="" class="row g-3">
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" name="bbirth"  value="<?PHP echo $data["bbirth"]; ?>">
                        </div>
                        <div class="col-md-6">
                          <label for="bgender" class="form-label">Jantina</label>
                          <input type="text" class="form-control" name="bgender" value="<?PHP echo $data["bgender"]; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="bplacebirth" class="form-label">Tempat Lahir</label>
                            <input type="text" class="form-control" name="bplacebirth" value="<?PHP echo $data["bplacebirth"]; ?>">
                          </div>
                        <div class="col-md-6">
                          <label for="bweight" class="form-label">Berat Lahir (kg)</label>
                          <input type="text" class="form-control" name="bweight" value="<?PHP echo $data["bweight"]; ?>">
                        </div>
                        <div class="col-md-6">
                          <label for="bsambut" class="form-label">Disambut Oleh</label>
                          <input type="text" class="form-control" name="bsambut" value="<?PHP echo $data["bsambut"]; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="sambut" class="form-label">Uri</label>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="uri" id="uri" value="1" <?PHP if($data["uri"] =="1") echo "checked";?>>
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="uri" id="uro" value="0" <?PHP if($data["uri"] =="0") echo "checked";?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="sintometrin" value="1" <?PHP if($data["sintometrin"] =="1") echo "checked";?>>
                                <label class="form-check-label" for="sintometrin">Sintometrin</label>
                            </div>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="ergometrin" value="1" <?PHP if($data["ergometrin"] =="1") echo "checked";?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="lahir_spontan" id="lahir_spontan" value="sefalik" <?PHP if($data["lahir_spontan"] =="sefalik") echo "checked";?>>
                              <label class="form-check-label" for="sefalik">
                                Sefalik
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="lahir_spontan" id="lahir_spontan"  value="breech" <?PHP if($data["lahir_spontan"] =="breech") echo "checked";?>>
                              <label class="form-check-label" for="gridRadios6">
                                Breech
                              </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="lahir_spontan" id="lahir_spontan" value="assisted" <?PHP if($data["lahir_spontan"] =="assisted") echo "checked";?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="lahir_alat" id="lahir_alat" value="forceps" <?PHP if($data["lahir_alat"] =="forceps") echo "checked";?>>
                              <label class="form-check-label" for="forceps">
                                Forceps
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="lahir_alat" id="lahir_alat" value="ventouse" <?PHP if($data["lahir_alat"] =="ventouse") echo "checked";?>>
                            ...
                            <div class="form-check">
                                ...
                                <input type="text" class="form-control" name="indication" value="<?PHP echo $data["indication"]; ?>">
                              </div>
                        </div>
                        <div class="col-md-6">
                            <label for="sambut" class="form-label">Cara Kelahiran - Caesarean</label>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="lahir_caesarean" id="lahir_caesarean"  value="elektif" <?PHP if($data["lahir_caesarean"] =="elektif") echo "checked";?>>
                              <label class="form-check-label" for="elektif">
                                Elektif
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="lahir_caesarean" id="lahir_caesarean"  value="kecemasan" <?PHP if($data["lahir_caesarean"] =="kecemasan") echo "checked";?>>
                              <label class="form-check-label" for="kecemasan">
                                Kecemasan
                              </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="lahir_caesarean" id="lahir_caesarean"  value="lscs" <?PHP if($data["lahir_caesarean"] =="lscs") echo "checked";?>>
                                <label class="form-check-label" for="lscs">
                                  LSCS
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="lahir_caesarean" id="lahir_caesarean"  value="klasikal" <?PHP if($data["lahir_caesarean"] =="klasikal") echo "checked";?>>
                            ...
                            <div class="form-check">
                                ...
                                <input type="text" class="form-control" name="indication2" value="<?PHP echo $data["indication2"]; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="sambut" class="form-label">Komplikasi Semasa Bersalin</label>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pph" id="pph"  value="1" <?PHP if($data["pph"] =="1") echo "checked";?>>
                              <label class="form-check-label" for="pph">
                                PPH
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="perineum" id="perineum"  value="1" <?PHP if($data["perineum"] =="1") echo "checked";?>>
                            ...
                            <div class="form-check">
                                ...
                                <input type="text" class="form-control" name="lain4" value="<?PHP echo $data["lain4"]; ?>">
                              </div>
                        </div>
                        <div class="col-md-6">
                            <label for="sambut" class="form-label">Rekod Bayi - Keadaan Bayi</label>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="lahir_hidup" id="lahir_hidup"  value="1" <?PHP if($data["lahir_hidup"] =="1") echo "checked";?>>
                              <label class="form-check-label" for="lahir_hidup">
                                Lahir hidup
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="lahir_hidup" id="lahir_hidup"  value="0" <?PHP if($data["lahir_hidup"] =="0") echo "checked";?>>
                              <label class="form-check-label" for="lahir_hidup">
                                Lahir mati
                              </label>
                            </div>
                            <div class="form-check">
                                ...
                                <input type="text" class="form-control" name="apgar" value="<?PHP echo $data["apgar"];?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="sambut" class="form-label">Rekod Bayi - Abnormaliti Kongenital</label>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="abnormaliti" id="abnormaliti"  value="1" <?PHP if($data["abnormaliti"] =="1") echo "checked";?>>
                              <label class="form-check-label" for="gridRadios17">
                                Ada 
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="abnormaliti" id="abnormaliti"  value="0" <?PHP if($data["abnormaliti"] =="0") echo "checked";?>>
                            ...
                            <div class="form-check">
                                ...
                                <input type="text" class="form-control" name="abn_nyata" value="<?PHP echo $data["abn_nyata"]; ?>">
                            </div>
                        </div>
                        <div class="text-center">
