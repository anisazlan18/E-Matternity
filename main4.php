              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="list-group">
                    ...
                    <a href="main4.php?id_patient=<?PHP echo $id_patient; ?>" class="list-group-item list-group-item-action active" aria-current="true">Kandungan Sekarang</a>
                    ...
                    <div class="card-body">
                      ...
                      <form method="post" action="" class="row g-3">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" name="tiroid" value="<?PHP echo $data["tiroid"]; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="jaundis" class="form-label">Jaundis</label>
                            <input type="text" class="form-control" name="jaundis" value="<?PHP echo $data["jaundis"]; ?>">
                          </div>
                        <div class="col-md-6">
                          <label for="vena" class="form-label">Vena Varikos</label>
                          <input type="text" class="form-control" name="vena" value="<?PHP echo $data["vena"]; ?>">
                        </div>
                        <div class="col-md-6">
                          <label for="payu" class="form-label">Payudara</label>
                          <input type="text" class="form-control" name="payu" value="<?PHP echo $data["payu"]; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="kardio" class="form-label">Sistem Kardiovaskular</label>
                            <input type="text" class="form-control" name="kardio" value="<?PHP echo $data["kardio"]; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="nafas" class="form-label">Sistem Pernafasan</label>
                            <input type="text" class="form-control" name="nafas" value="<?PHP echo $data["nafas"]; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="abdomen" class="form-label">Abdomen</label>
                            <input type="text" class="form-control" name="abdomen" value="<?PHP echo $data["abdomen"]; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="lain3" class="form-label">Lain-lain (Nyatakan)</label>
                            <input type="text" class="form-control" name="lain3" value="<?PHP echo $data["lain3"]; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="gigi" class="form-label">Gigi</label>
                            <input type="text" class="form-control" name="gigi" value="<?PHP echo $data["gigi"]; ?>">
                        </div>
