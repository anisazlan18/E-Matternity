...
$diabetes	= (isset($_POST['diabetes'])) ? trim($_POST['diabetes']) : '';
$daraht		= (isset($_POST['daraht'])) ? trim($_POST['daraht']) : '';
$alergi 	= (isset($_POST['alergi'])) ? trim($_POST['alergi']) : '';
$asthma		= (isset($_POST['asthma'])) ? trim($_POST['asthma']) : '';
$sjantung	= (isset($_POST['sjantung'])) ? trim($_POST['sjantung']) : '';
$tibi		= (isset($_POST['tibi'])) ? trim($_POST['tibi']) : '';
$lain		= (isset($_POST['lain'])) ? trim($_POST['lain']) : '';

$diabetes2	= (isset($_POST['diabetes2'])) ? trim($_POST['diabetes2']) : '';
$daraht2	= (isset($_POST['daraht2'])) ? trim($_POST['daraht2']) : '';
$alergi2 	= (isset($_POST['alergi2'])) ? trim($_POST['alergi2']) : '';
$asthma2	= (isset($_POST['asthma2'])) ? trim($_POST['asthma2']) : '';
$sjantung2	= (isset($_POST['sjantung2'])) ? trim($_POST['sjantung2']) : '';
$tibi2		= (isset($_POST['tibi2'])) ? trim($_POST['tibi2']) : '';
$lain2		= (isset($_POST['lain2'])) ? trim($_POST['lain2']) : '';

$rubella		= (isset($_POST['rubella'])) ? trim($_POST['rubella']) : '';
$tetanus			= (isset($_POST['tetanus'])) ? trim($_POST['tetanus']) : '';
$dos2			= (isset($_POST['dos2'])) ? trim($_POST['dos2']) : '';
$dostambahan		= (isset($_POST['dostambahan'])) ? trim($_POST['dostambahan']) : '';
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="list-group">
                    ...
                    <a href="a-main2.php" class="list-group-item list-group-item-action" role="button">Perihal Kandungan Lalu</a>
                    <a href="a-main3.php" class="list-group-item list-group-item-action active" aria-current="true">Riwayat Kesihatan Ibu/Keluarga</a>
