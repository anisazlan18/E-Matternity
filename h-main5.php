              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="list-group">
                    ...
                    <a href="h-main5.php?id_patient=<?PHP echo $id_patient; ?>" class="list-group-item list-group-item-action active" aria-current="true">Pemeriksaan Kandungan Sekarang</a>
